/*
    ...
    In order to implement this function, you'll also need to implement a merge function that takes in two sorted arrays and a comparator and
    returns a new sorted array. You implemented this function in the previous exercise, so copy and paste that code here.
...
function startComp(a, b){
     if(!a.age ?a<b:null) return true;
     else if(a.age<b.age) return false;
     else if(a.age)return true;
    else return false;
}
...
function mergeSort(arr){
    ...
    let mid = Math.floor(arr.length/2),
        left = mergeSort(arr.splice(mid)),
        right = mergeSort(arr.splice(0, mid));
