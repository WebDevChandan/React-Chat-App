...
const disabledLangBtn = () => {
  ...
  else hiBtn.setAttribute("disabled", "");
}
const enableLangBtn = () => {
  if (chosenLanguage === "hi-IN") engBtn.removeAttribute("disabled", "");
  else hiBtn.removeAttribute("disabled", "");
};
...
const tutorial = document.querySelector(".tutorial"),
  tour = tutorial.querySelector(".tour"),
  next = tutorial.querySelector('.next'),
  prev = tutorial.querySelector('.prev'),
  message = tutorial.querySelector('.message');
...
document.querySelector('.skip').addEventListener('click', () => {
  tutorial.classList.add("hide_tutorial");
})
...
// LocalStorage
const storedLang = () => {
  if (localStorage.getItem("hiLng") && localStorage.getItem("engLng")) {
    if (localStorage.getItem("hiLng") !== "null")
      hiBtn.setAttribute(localStorage.getItem("hiLng"), "");
    else engBtn.setAttribute(localStorage.getItem("engLng"), "");
  } else engBtn.setAttribute('checked', "");

  //Save in Local Storage to not repeat it again
